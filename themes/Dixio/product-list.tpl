...
{if isset($products) && $products}
	...
	{if $page_name !='index' && $page_name !='product'}
		{*2*}{assign var='nbItemsPerLine' value=3}
		{*2*}{assign var='nbItemsPerLineTablet' value=2}
		{*2*}{assign var='nbItemsPerLineMobile' value=3}
	{else}
		{*1*}{assign var='nbItemsPerLine' value=4}
		{*1*}{assign var='nbItemsPerLineTablet' value=3}
		{*1*}{assign var='nbItemsPerLineMobile' value=2}
	{/if}
